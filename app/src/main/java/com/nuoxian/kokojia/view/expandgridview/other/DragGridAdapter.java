package com.nuoxian.kokojia.view.expandgridview.other;
...
import com.nuoxian.kokojia.view.expandgridview.CustomBehindView;
...
public class DragGridAdapter extends BaseAdapter{
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		MyApplication.imageLoader.displayImage(iconInfo.getResIconId(),viewHold.ivIcon,MyApplication.options);
//		viewHold.ivIcon.setImageResource(iconInfo.getResIconId());//加载图片
