 ...
 */
public class SellOrderNoPay extends SellOrderBaseFragment {

    private SellOrderAdapter adapter;
    private List<SellOrder.DataBean> list;
    private String uid, word = "";
    private static String status = "10";
    private int page = 1;

    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        EventBus.getDefault().register(SellOrderNoPay.this);
    }
    ...
    public void onEventMainThread(Bundle bundle) {
        if ("SellOrderNoPay".equals(bundle.getString("fragment"))) {
    ...
    public void onDestroy() {
        super.onDestroy();
        EventBus.getDefault().unregister(SellOrderNoPay.this);
    }
}
