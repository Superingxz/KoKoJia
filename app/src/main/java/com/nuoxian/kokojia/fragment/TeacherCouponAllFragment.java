 ...
 * 创建优惠券   全部
 */
public class TeacherCouponAllFragment extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        EventBus.getDefault().register(TeacherCouponAllFragment.this);
    }
    ...
    public void onEventMainThread(Bundle bundle) {
        if("refresh".equals(bundle.getString("ok"))){//接收到重新加载数据的广播
            //刷新
            page = 1;
            mList.clear();
            getData(CommonValues.TO_REFRESH, layout);
            adapter.notifyDataSetChanged();
        }
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        //取消注册
        EventBus.getDefault().unregister(TeacherCouponAllFragment.this);
    }
}
