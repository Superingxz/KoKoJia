 ...
 */
public class SellOderAll extends SellOrderBaseFragment {
    ...
    public void onAttach(Context context) {
        ...
        EventBus.getDefault().register(SellOderAll.this);
    }
        ...
        setOnItemClicklistener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if ("1".equals(list.get(position).getType())) {
                    ...
                    Log.d("haha", "onItemClick: " + list.get(position).getCourse_id());
    ...
    public void onEventMainThread(Bundle bundle) {
        if ("SellOrderAll".equals(bundle.getString("fragment"))) {
    ...
    public void onDestroy() {
        super.onDestroy();
        EventBus.getDefault().unregister(SellOderAll.this);
    }
}
