 ...
 */
public class MyPackageSelling extends SellOrderBaseFragment {
    private List<MyPackage.DataBean> list;
    private String uid, word = "";
    private static String status = "2";
    ...
    public void onAttach(Context context) {
        ...
        EventBus.getDefault().register(MyPackageSelling.this);
    }
    ...
    public void onEventMainThread(Bundle bundle) {
        if ("MyPackageSelling".equals(bundle.getString("fragment"))) {
    ...
    public void onDestroy() {
        super.onDestroy();
        EventBus.getDefault().unregister(MyPackageSelling.this);
    }
}
