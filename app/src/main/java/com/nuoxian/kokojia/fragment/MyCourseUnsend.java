 ...
 */
public class MyCourseUnsend extends MyCourseBaseFragment {
    ...
    public void onAttach(Context context) {
        ...
        EventBus.getDefault().register(MyCourseUnsend.this);
    }
    ...
    public void onEventMainThread(Bundle bundle) {
        if("MyCourseUnsend".equals(bundle.getString("fragment"))){
    ...
    public void onDestroy() {
        super.onDestroy();
        EventBus.getDefault().unregister(MyCourseUnsend.this);
    }
}
