 ...
 */
public class MyCourseStopSell extends MyCourseBaseFragment {
    ...
    public void onAttach(Context context) {
        ...
        EventBus.getDefault().register(MyCourseStopSell.this);
    }
    ...
    public void onEventMainThread(Bundle bundle) {
        if("MyCourseStopSell".equals(bundle.getString("fragment"))){
    ...
    public void onDestroy() {
        super.onDestroy();
        EventBus.getDefault().unregister(MyCourseStopSell.this);
    }
}
