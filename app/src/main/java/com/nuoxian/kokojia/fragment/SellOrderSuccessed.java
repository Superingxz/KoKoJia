 ...
 */
public class SellOrderSuccessed extends SellOrderBaseFragment {

    private SellOrderAdapter adapter;
    private List<SellOrder.DataBean> list;
    private String uid, word = "";
    private static String status = "50";
    private int page = 1;

    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        EventBus.getDefault().register(SellOrderSuccessed.this);
    }
    ...
    public void onEventMainThread(Bundle bundle) {
        if ("SellOrderSuccessed".equals(bundle.getString("fragment"))) {
    ...
    public void onDestroy() {
        super.onDestroy();
        EventBus.getDefault().unregister(SellOrderSuccessed.this);
    }
}
