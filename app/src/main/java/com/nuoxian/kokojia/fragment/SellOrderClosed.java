 ...
 */
public class SellOrderClosed extends SellOrderBaseFragment {

    private SellOrderAdapter adapter;
    private List<SellOrder.DataBean> list;
    private String uid, word = "";
    private static String status = "40";
    private int page = 1;

    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        EventBus.getDefault().register(SellOrderClosed.this);
    }
    ...
    public void onEventMainThread(Bundle bundle) {
        if ("SellOrderClosed".equals(bundle.getString("fragment"))) {
    ...
    public void onDestroy() {
        super.onDestroy();
        EventBus.getDefault().unregister(SellOrderClosed.this);
    }
}
