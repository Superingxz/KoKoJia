 ...
 */
public class MyCourseSelling extends MyCourseBaseFragment {
    ...
    public void onAttach(Context context) {
        ...
        EventBus.getDefault().register(MyCourseSelling.this);
    }
    ...
    public void onEventMainThread(Bundle bundle) {
        if("MyCourseSelling".equals(bundle.getString("fragment"))){
    ...
    public void onDestroy() {
        super.onDestroy();
        EventBus.getDefault().unregister(MyCourseSelling.this);
    }
}
