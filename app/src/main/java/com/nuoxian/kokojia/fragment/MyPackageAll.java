 ...
 */
public class MyPackageAll extends SellOrderBaseFragment {
    ...
    public void onAttach(Context context) {
        ...
        EventBus.getDefault().register(MyPackageAll.this);
    }
    ...
    public void onEventMainThread(Bundle bundle) {
        if ("MyPackageAll".equals(bundle.getString("fragment"))) {
    ...
    public void onDestroy() {
        super.onDestroy();
        EventBus.getDefault().unregister(MyPackageAll.this);
    }
}
