 ...
 */
public class MyPackageStopSell extends SellOrderBaseFragment {
    ...
    public void onAttach(Context context) {
        ...
        EventBus.getDefault().register(MyPackageStopSell.this);
    }
    ...
    public void onEventMainThread(Bundle bundle) {
        if ("MyPackageStopSell".equals(bundle.getString("fragment"))) {
    ...
    public void onDestroy() {
        super.onDestroy();
        EventBus.getDefault().unregister(MyPackageStopSell.this);
    }
}
